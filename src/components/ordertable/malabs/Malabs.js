...
export default function MLabsOrdersTable() {
  ...
  return (
    <div>
      <h2 className={classes.headerStyle}>Malabs Items</h2>
      <div
            ...
            {loading ? (
              ...
              response?.results?.map((row, index) => (
                <TableRow key={index} className={classes.rowStyle}>
                  ...
                  <TableCell align="center">{row.manufacturer_no}</TableCell>
                  ...
                  <TableCell align="center">
                    <>
                      <p className={classes.priceStyle}>{row?.upc_code}</p>
                      {row?.url ? (
